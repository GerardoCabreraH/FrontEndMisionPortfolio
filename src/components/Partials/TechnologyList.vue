        ...
        <div class="column">
            <div class="card-technology">
                <div class="card-technology-container">
                    <h3><b><span class="icon-technology"><i class="fa-solid fa-desktop"></i></span></b></h3>
                    <h3><b>Diseño UI/UX</b></h3>
                    <p>Para crear la interfaz y experiencia de usuario, primero recojo los requisitos para la pagina web para luego darle forma al historial de usuario, luego formo diagramas de flujo, diagramas de sitio, diagramas UML y diagramas entidad-relación. Luego formo el modelado de la pagina en blanco y negro y al final le doy los colores y el prototipo de la pagina.</p>
                    <p>Programas</p>
                    <ul>
